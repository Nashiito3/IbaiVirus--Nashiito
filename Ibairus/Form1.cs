...
namespace Ibai_Virus
{
    public partial class Ibai_Virus : Form
    {
        ...
        public Ibai_Virus()
        {
            ...
            //Extract
            Extract("Ibai_Virus", Application.StartupPath, "Resources", "AxInterop.WMPLib.dll");
            Extract("Ibai_Virus", Application.StartupPath, "Resources", "Interop.WMPLib.dll");
            Extract("Ibai_Virus", @"C:\Program Files\Temp", "Resources", "ibai.wav");
            Extract("Ibai_Virus", @"C:\Program Files\Temp", "Resources", "ibai.mp4");
            Extract("Ibai_Virus", @"C:\Program Files\Temp", "Resources", "static.mp4");
            Extract("Ibai_Virus", @"C:\Program Files\Temp", "Resources", "static_noise.wav");
            InitializeComponent();
        }

        private void Ibai_Virus_Load(object sender, EventArgs e)
        {
        ...
        public void Video_func2()
        {
            ...
            if (File.Exists(@"C:\Program Files\Temp\ibai.wav") && File.Exists(@"C:\Program Files\Temp\ibai.mp4"))
            {
                try
                {
                    back_snd = new SoundPlayer(@"C:\Program Files\Temp\ibai.wav");
                    Player1.URL = @"C:\Program Files\Temp\ibai.mp4";
                    Player1.settings.setMode("loop", true);
        ...
        private void Ibai_Virus_FormClosing(object sender, FormClosingEventArgs e)
        {
            e.Cancel = true;
        }
    }
